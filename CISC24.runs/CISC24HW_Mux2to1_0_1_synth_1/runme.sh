...
HD_PWD='F:/CISC24/CISC24.runs/CISC24HW_Mux2to1_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CISC24HW_Mux2to1_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CISC24HW_Mux2to1_0_1.tcl
