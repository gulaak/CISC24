...
HD_PWD='F:/CISC24/CISC24.runs/CISC24HW_RamAddAMux_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CISC24HW_RamAddAMux_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CISC24HW_RamAddAMux_0_0.tcl
