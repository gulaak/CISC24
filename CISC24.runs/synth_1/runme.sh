...
HD_PWD='C:/Users/Aiden/Desktop/CISC24/CISC24.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps2Controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps2Controller.tcl
