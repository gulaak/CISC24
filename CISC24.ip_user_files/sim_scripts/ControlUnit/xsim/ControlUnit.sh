...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot ControlUnit xil_defaultlib.ControlUnit -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ControlUnit -key {Behavioral:sim_1:Functional:ControlUnit} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ControlUnit.wdb xsim.dir)
