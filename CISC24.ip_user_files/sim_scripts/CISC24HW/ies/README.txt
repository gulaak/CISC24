...
#
# Generated by export_simulation on Thu May 03 22:54:38 -0400 2018
#
################################################################################
...
'-reset_run' switch to the './CISC24HW.sh' script.

./CISC24HW.sh -reset_run
...
./CISC24HW.sh -noclean_files

For more information on the script, please type './CISC24HW.sh -help'.
